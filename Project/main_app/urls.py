...
path('api/incidents/<int:incident_id>/reports/', ReportListCreateView.as_view(), name='report-list-create'),
path('api/reports/<int:pk>/', ReportDetailView.as_view(), name='report-detail'),
path('api/reports/<int:report_id>/comments/', CommentListCreateView.as_view(), name='comment-list-create'),
]
